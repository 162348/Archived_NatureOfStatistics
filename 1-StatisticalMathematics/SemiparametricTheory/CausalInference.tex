...
\begin{history}[調査観察データに対する因果推論，統計的機械学習，Bayes統計学]\mbox{}
    \begin{enumerate}
...
\begin{history}[Regression discontinuity design]
...
\begin{history}[Marschakと計量経済学のノンパラ化 + グラフィカルモデル]
