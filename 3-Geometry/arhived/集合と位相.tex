...
\begin{theorem}[開写像が全射・単射であることはモノ射・エピ射であることに等しい]
...
\begin{proposition}[Hilbert cube]
...
\begin{theorem}[有限集合上の数列の空間は$I$に同相]
...
\begin{definition}[quotient space / identification space]
...
\begin{definition}[quotient map / identification map, saturated]
    $p:X\to Y$を全射とする．
    \begin{enumerate}
...
\begin{corollary}[一点を潰して得られる空間(quotient by a subspace)]
...
\begin{lemma}[空間の位相が，被覆の定める包含の族が引き起こす像位相であることの特徴付け]
...
\begin{example}[stalk, germ, sheaf]
...
\begin{history}[ネットの歴史\cite{Kelley}]
...
\begin{proposition}[Baire category theorem 2]
...
\begin{theorem}[Whitehead-Michael]
...
\begin{definition}[Tychonoff space / completely regular space]\mbox{}
    \begin{enumerate}
...
\begin{proposition}[Stone-Čechコンパクト化 (1937)\footnote{E. Cech. \textit{On bicompact spaces}. Ann. of Math. (2) 38:823-844 と M. H. Stone (1937). \textit{Appllications of the theory of Boolean rings to general topology}.}]
    任意の完全正則空間$X$に対して，
    \begin{enumerate}
...
\begin{theorem}[Stone-Čechコンパクト化の特徴付け]
