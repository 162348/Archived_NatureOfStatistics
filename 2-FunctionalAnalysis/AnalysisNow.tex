...
\begin{theorem}[作用素族は各点有界ならば一様有界 (Banach-Steinhaus / 共鳴定理)]
...
\begin{tcolorbox}[colframe=ForestGreen, colback=ForestGreen!10!white,breakable,colbacktitle=ForestGreen!40!white,coltitle=black,fonttitle=\bfseries\sffamily,
title=]
    命題\ref{prop-dual-space-of-TVS-with-weak-topology}は，$\sigma(X,Y)$-位相に関する一般理論を主張する．
...
\begin{proposition}[$\sigma(X,Y)$-位相の一般理論]\label{prop-dual-space-of-TVS-with-weak-topology}
...
\begin{tcolorbox}[colframe=ForestGreen, colback=ForestGreen!10!white,breakable,colbacktitle=ForestGreen!40!white,coltitle=black,fonttitle=\bfseries\sffamily,
    title=]
    これは，命題\ref{prop-dual-space-of-TVS-with-weak-topology}に始まる$\sigma(X,Y)$-位相の一般理論の一部であるが，弱位相の得意な点は，ノルム位相とは有限次元の場合を除いて一般的には異なるが，双対空間は等しく$X^*$になることである．
    凸集合について，閉性は同値になる．
\end{tcolorbox}
...
\begin{corollary}\label{cor-characterization-of-weak-star-continuousness}
    ...
    \begin{enumerate}
        \item $w^*$-連続である．すなわち，$x\in X$．\footnote{$w^*$位相の定義\ref{def-weak-star-topology}と命題\ref{prop-dual-space-of-TVS-with-weak-topology}より．}
